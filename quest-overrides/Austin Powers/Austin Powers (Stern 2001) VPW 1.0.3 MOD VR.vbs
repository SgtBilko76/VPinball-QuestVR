...
'VR Room
Const VRRoom = 1 ' Quest VR override (was 0) 'Turns on VR Room and Cabinet.   VPVR must also be set for desktop play. 
...
If VRRoom = 1 Then 'Turns on VR Room and Cabinet
	Dim VRThings
