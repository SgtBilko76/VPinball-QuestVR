...
'----- VR Options -----
Const VRRoom = 3 ' Quest VR override (was 0)						'0 - Off, 1 - Simpsons Room, 2 - Minimal Room, 3 - Ultra-Minimal Room
Const VRBackglassGI = 1					'0 - Static VR Backglass (like real Table), 1 - VR Backglass shuts off with table GI
Const GlassScratches = 1				'0 - Off, 1 - Glass scratches on  (Will only run in VR rooms 1 and 2)
...
'			Flasher4.opacity = 10 *  FlasherWallIntensity * ObjLevel(nr)^2.5
		...
		Case 10
			HHead.blenddisablelighting = Flasherlit10.blenddisablelighting / 1.9 + (0.045 * gilvl - 0.01)	'1.1
	End Select
...
Sub InitLampsNF()
	...
	dim x : for x = 0 to 140 : Lampz.FadeSpeedUp(x) = 1/2 : Lampz.FadeSpeedDown(x) = 1/8 : next
	Lampz.FadeSpeedUp(111) = 1/10 : Lampz.FadeSpeedDown(111) = 1/10 'GI related

	'bumper towers
	Lampz.FadeSpeedUp(18) = 1/6 : Lampz.FadeSpeedDown(18) = 1/20
	Lampz.FadeSpeedUp(19) = 1/6 : Lampz.FadeSpeedDown(19) = 1/20
